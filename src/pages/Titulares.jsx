              ...
              <CardContent className="p-4">
                <div className="grid grid-cols-4 gap-3 items-start">
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <div className="flex justify-center items-center w-[100px] h-[100px] mx-auto">
                      <span className="text-xs px-2 py-0.5 rounded-full bg-blue-100 text-blue-700 font-medium text-center">
                  ...
                  <div className="flex flex-col gap-1">
                    <div className="flex justify-center items-center w-[100px] h-[100px] mx-auto">
                      <span className="text-xs px-2 py-0.5 rounded-full bg-purple-100 text-purple-700 font-medium text-center">
                    ...
                    <div className="flex justify-center items-center w-[100px] h-[100px] mx-auto">
                      <span className="text-xs px-2 py-0.5 rounded-full bg-gray-100 text-gray-700 font-medium text-center">
