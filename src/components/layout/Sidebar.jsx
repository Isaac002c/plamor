...
import { LayoutDashboard, Users, CreditCard, BarChart2, UserSquare2, X } from "lucide-react";
...
export default function Sidebar({ open, onClose }) {
  ...
  const [aba, setAba] = useState("secretaria");

  const items = modulos[aba];
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          "fixed top-0 left-0 z-50 h-full w-52 bg-sidebar text-sidebar-foreground flex flex-col transition-transform duration-300 lg:translate-x-0",
